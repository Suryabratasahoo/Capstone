            ...
            <div className="w-full lg:w-[50%] h-full overflow-y-auto flex flex-col justify-center items-center px-8 sm:px-16 md:px-24 py-12">
                <div className="w-full max-w-[480px]">
                    ...
                    <div className="flex items-center gap-4 my-8">
                        <span className="text-zinc-500 font-semibold mx-auto">
                            OR
                        </span>
                    </div>
                    ...
                    <div className="space-y-3">
                        <Button
                            variant="outline"
                            className="w-full h-14 flex items-center justify-center gap-3 border-zinc-200 rounded-[32px] hover:bg-zinc-50 transition-colors font-semibold text-zinc-700 text-base"
                        >
                    ...
                    <div className="mt-12 text-center text-sm font-medium text-zinc-600">
                        Don't have an account?{' '}
                        <Link href="/auth/register" className="text-zinc-900 underline hover:no-underline font-semibold">
                            Sign up
                        </Link>
                    </div>
                </div>
