...
export default function SectionThree() {
  return (
    <section className="w-full min-h-screen bg-[#600619] flex flex-col lg:flex-row items-stretch lg:h-screen lg:overflow-hidden select-none relative overflow-y-auto lg:overflow-y-hidden">
      ...
      <div className="w-full lg:w-1/2 pt-16 lg:pt-0 pb-16 lg:pb-0 px-8 sm:px-12 md:px-16 lg:px-20 flex flex-col justify-start lg:justify-center bg-[#661119] relative shrink-0 lg:h-full lg:overflow-y-auto">
        ...
        <div className="flex flex-col gap-10 lg:gap-12 w-full max-w-2xl">
          ...
          {/* CTA Button */}
          <button className="bg-[#e9e0f2] text-[#661119] hover:bg-white hover:text-black hover:scale-[1.02] active:scale-[0.98] transition-all rounded-full px-10 py-5 font-black text-base max-w-xs text-center shadow-2xl cursor-pointer">
      ...
      <div className="w-full lg:w-1/2 h-[560px] lg:h-full flex items-center justify-center bg-[#661119] shrink-0 p-6 sm:p-8 md:p-12 lg:p-16">
        <div className="w-full max-w-[800px] aspect-[4/3] max-h-[80vh] relative flex items-center justify-center">
          <video
            src="/section3.mp4"
            autoPlay
            loop
